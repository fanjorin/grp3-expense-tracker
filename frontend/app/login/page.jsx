        ...
        <div className="hidden md:flex w-[38%] bg-blue-600 p-8 flex-col gap-5 text-white select-none">
         ...
         <Logo textColor="text-white" />
          ...
          <p className="text-sm text-blue-200 leading-relaxed">
            Continue tracking your spending, staying on budget, and reaching your financial goals.
          </p>

          {/* ── Testimonial Box — pushed to bottom ── */}
          <div className="mt-auto bg-blue-500 bg-opacity-50 rounded-xl p-4">
            <p className="text-sm text-white italic leading-relaxed">
              &ldquo;The best expense tracker I've ever used. Simple, fast, and reliable.&rdquo;
            </p>
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 bg-white">
          <div className="w-full max-w-[460px]">
            ...
            <div className="flex gap-6 mb-10 border-b border-slate-100 text-sm font-medium">
              <button type="button" className="pb-3 text-[#0052CC] border-b-2 border-[#0052CC] font-semibold">Log in</button>
              <Link href="/signup" className="pb-3 text-slate-400 hover:text-slate-600 transition">Sign up</Link>
            </div>
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Link href="/forgot-password" virtual className="text-xs font-medium text-[#0052CC] hover:underline">Forgot password?</Link>
                </div>
              ...
              <button type="button" className="w-full flex items-center justify-center gap-2.5 p-3.5 border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 hover:bg-slate-50 active:bg-slate-100 transition shadow-sm">
            ...
            <p className="text-center mt-8 text-sm text-slate-500">
              No account yet? <Link href="/signup" className="text-[#0052CC] font-medium hover:underline">Create an account</Link>
            </p>
