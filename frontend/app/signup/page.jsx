  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        router.push(
          `/signup/set-password?email=${encodeURIComponent(formData.email)}`,
        );
      } else {
      ...
      <div className="flex w-full max-w-4xl rounded-2xl shadow-lg overflow-hidden min-h-[540px]">
        ...
        <div className="hidden md:flex w-[38%] bg-blue-600 p-8 flex-col gap-5 text-white select-none">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-xs font-bold tracking-widest text-blue-300 uppercase mt-4">
              Setup Steps
            </p>
            ...
            <div className="flex flex-col">
              <div className="flex items-start gap-3">
                <div className="w-7 h-7 min-w-[28px] rounded-full bg-white text-blue-600 flex items-center justify-center font-bold text-xs shadow-sm">
                  1
                </div>
                <div>
            ...
            <div className="flex flex-col">
              <div className="flex items-start gap-3">
                <div className="w-7 h-7 min-w-[28px] rounded-full border-2 border-blue-400 flex items-center justify-center font-semibold text-xs text-blue-300">
                  2
                </div>
                <div>
          ...
          <div className="mt-auto bg-blue-500 bg-opacity-50 rounded-xl p-4">
            <p className="text-sm text-white italic leading-relaxed">
              &ldquo;Setting up took less than 2 minutes. Now I know exactly
              where every naira goes.&rdquo;
            </p>
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 bg-white">
          <div className="w-full max-w-[460px]">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2.5 p-3.5 border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 hover:bg-slate-50 active:bg-slate-100 transition"
              >
                <svg
                  width="16"
                  height="16"
